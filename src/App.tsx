  ...
  return(
    <main className="grid grid-cols-12 grid-rows-12 h-screen bg-[url('./assets/cherry.png')] bg-center bg-cover">
      ...
      <div className="bg-zinc-900 row-span-2 col-span-12 grid grid-cols-24 grid-rows-24 rounded-2xl m-3 z-10">
        <img src={ImageIcon} alt="minha imagem" className='w-10 col-span-2 rounded-full col-start-1 row-start-7 ml-3 sm:ml-5 sm:row-start-7 sm:w-11 md:w-12 md:row-start-7 md:ml-5 lg:ml-7 lg:row-start-7 xl:w-14 xl:ml-4 xl:row-start-6 2xl:w-22 2xl:row-start-4 2xl:ml-9'/>
